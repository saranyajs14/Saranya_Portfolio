...
export default function HomeContent() {
  ...
  }, [profession, isDeleting, loopNum, typingSpeed, professions, mounted])
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 flex items-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        ></div>
        <div
          className="absolute w-6 h-6 bg-gray-600/20 rounded-sm transition-all duration-700 ease-out animate-database-sync"
          style={{
        ...
        <div className="absolute top-40 right-20 w-6 h-6 bg-gray-600/30 rounded-sm animate-circuit-flow"></div>
        ...
        <div className="absolute bottom-60 right-1/3 w-5 h-5 bg-gray-600/20 rounded-sm animate-pulse-delayed"></div>
        ...
        <div className="absolute bottom-32 left-1/4 w-8 h-8 border-2 border-gray-600/30 rotate-12 animate-pulse-slow"></div>

        {/* Simplified code elements */}
        <div className="absolute bottom-1/4 right-5 text-gray-600/20 text-4xl font-mono animate-server-pulse">[DB]</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="md:w-1/2 space-y-6">
            ...
            <Link
  href="/Resume_Saranya_SDE_AI_1.pdf"
  ...
  <div className="absolute inset-0 bg-white/10 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
          ...
          <div className="md:w-1/2 flex justify-center md:justify-end relative animate-fade-in-left animation-delay-600">
            ...
            <div className="absolute -bottom-4 -right-4 w-6 h-6 bg-gray-600/40 rounded-sm animate-database-sync"></div>
